...
<template>
    <form class="m-10 shadow-md p-8">
        ...
        <div class="flex items-start mb-6">
            <label for="remember" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Do have an account ? 
        ...
        <button @click="signInwithGoogle" id="signwithgoogle" type="submit" class="text-white bg-orange-400  hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 shadow dark:focus:ring-blue-800">Sign In with Google</button>
    </form>
</template>
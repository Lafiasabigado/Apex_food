...
<template>
     <form class="m-10 shadow-md p-10">
        <h2 class="text-orange-400 uppercase font-bold text-center text-2xl">Log In</h2>
        <div class="mb-6">
        ...
        <div class="flex items-start mb-6">
            <p class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Don't have an account ?
                <router-link to="/views/signup">
                    <a href="" class="text-orange-600 hover:underline dark:text-blue-500">Sign Up</a>.
                </router-link> 
            </p>
        </div>
        <button @click="register" id="login" type="submit" class="text-white bg-orange-400 hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 m-2">Submit</button>
